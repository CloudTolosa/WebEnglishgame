...
import '../assets/styles/components/Titulos.scss';
...
class Ahorcado extends Component {
  ...
  getPalabraAAdivinar(){
    let palabras = [ "CAT", "COW", "DOG", "HORSE", "SNAKE" ];
  ...
  fallos(){
    let linka = "src/assets/static/" + this.state.numFallos + ".png";
    return linka;
  }
  ...
  render() {
    return (
          ...
          <div>
            <div>
            <p className="titulo">HANGMAN GAME</p>
            </div>
          <center>
          <img src = {this.fallos()} alt = "Not"/>
          </center>
